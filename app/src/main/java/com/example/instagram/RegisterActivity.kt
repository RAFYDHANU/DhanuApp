...
class RegisterActivity : AppCompatActivity() {
    ...
    //memasukan data ke dalam data base/memberikan aksi ketika text di masukan ke dalam edit text dan datanya di jadikan ditampung di dalam string
    ...
    private fun saveUserInfo(
        ...
        userMap["image"] = "https://firebasestorage.googleapis.com/v0/b/social-mdia.appspot.com/o/Default%20Images%2Fprofile.png?alt=media&token=f9a92dcb-de10-4856-9212-4012db083695"
